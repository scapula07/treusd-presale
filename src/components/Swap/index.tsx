...
export default function Swap() {
  ...
  return (
    <div className='md:w-[25%] w-full  border-[2px]  flex flex-col items-center py-8 rounded-lg border-[#4B0082] bg-[#0A0A23E6] space-y-4 '>
          ...
          <div className='flex flex-col items-center w-full space-y-4 px-4'>
               <div className='flex flex-col items-center space-y-2 w-full'> 
                     <h5 className='text-lg md:text-xl'>USDC Amount</h5>
                     <input
                      placeholder='Enter USDC amount' 
                      type={"number"}
                      className="w-full py-2 px-4  border-[#4B0082] border bg-[#121232] text-sm md:text-base"
                      value={amount}
               ...
               <div className='flex flex-col items-center space-y-2 w-full'> 
                     <h5 className='text-lg md:text-xl'>TREUSD Amount</h5>
                     <input 
